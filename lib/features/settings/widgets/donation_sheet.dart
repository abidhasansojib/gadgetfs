...
class _DonationSheetState extends State<DonationSheet> {
  ...
  final List<_DonationFocus> _focuses = const [
    _DonationFocus(id: 'compat', title: 'Kernel Compatibility', subtitle: 'OEM quirks, UDC binding, cleanup'),
    _DonationFocus(id: 'profiles', title: 'Profiles & Templates', subtitle: 'VID/PID, strings, safer defaults'),
    _DonationFocus(id: 'service', title: 'Foreground Service', subtitle: 'Background stability and resilience'),
    _DonationFocus(id: 'testing', title: 'Quick Test Actions', subtitle: 'Mouse/key validation improvements'),
    _DonationFocus(id: 'docs', title: 'Docs & Onboarding', subtitle: 'Troubleshooting and guided setup'),
  ];
  ...
  String _buildShareText({required bool isBtc, _DonationFocus? focus}) {
    ...
    return ''
        'Support GadgetFS - Open Source USB Gadget Tool\n'
        '$focusLine'
        '$chainLine'
        '$addrLine'
        'Repo: ${widget.repoUrl}\n';
  ...
  Future<void> _thankYou() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Your support helps keep GadgetFS reliable across kernels and devices. Thank you for funding open-source maintenance and safer USB gadget workflows.',
  ...
  Widget _buildDonationOptionsHeader(ThemeData theme, ColorScheme cs) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Support kernel compatibility, safer configfs automation, and ongoing maintenance',
          style: theme.textTheme.bodyMedium?.copyWith(
            color: cs.onSurface.withOpacity(0.7),
          ),
        ),
