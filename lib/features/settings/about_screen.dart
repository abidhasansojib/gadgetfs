...
class _AboutScreenState extends State<AboutScreen> {
  ...
  String _appName() => (_info?.appName.trim().isNotEmpty ?? false) ? _info!.appName : 'GadgetFS';
      ...
      body: ListView(
        ...
        children: [
          ...
          SectionCard(
            ...
            subtitle: 'Root-only USB gadget workflows',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'GadgetFS helps create and bind USB gadgets via Linux configfs on rooted Android devices. It is designed for practical, local-first workflows: no accounts, no tracking, no ads.',
                    style: theme.textTheme.bodyMedium?.copyWith(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'No warranty. Use at your own risk. USB gadget activation can affect charging/ADB and may disrupt enterprise policies or device security.',
                            style: theme.textTheme.bodySmall?.copyWith(
